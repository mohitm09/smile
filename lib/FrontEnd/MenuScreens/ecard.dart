      ...
      child: Scaffold(
        ...
        body: ListView(
          children: [
            ...
            otherInformation(
                'About', 'Feel free to contact us whenever you need us.'),
            otherInformation('Concerned person : ', "Neelam Verma"),
            otherInformation(
                'Timings : ', "Monday-wednesday-Thursday : 1:30 PM to 4:30 PM"),
            otherInformation('Contact number : ', "8235811093"),
            otherInformation('E-mail : ', "Neelam.Verma@niituniversity.in"),
          ],
        ),
      ),
    );
