...
import 'package:smile/FrontEnd/MainScreen/home_page.dart';
    ...
    return Padding(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
            ...
            padding:
                EdgeInsets.only(left: 20.0, right: 20.0, top: 7.0, bottom: 7.0),
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(20.0)))),
        child: Text(
          buttonName,
          style: TextStyle(
              fontSize: 25.0, letterSpacing: 1.0, fontWeight: FontWeight.w400),
        ),
        onPressed: () async {
          if (this._signUpKey.currentState!.validate()) {
            ...
            if (response == EmailSignUpResults.SignUpCompleted) {
              ...
              final String msg =
                  response == EmailSignUpResults.EmailAlreadtExist
                      ? 'Email Already Exist'
